<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AltaEquipo.aspx.cs" Inherits="ServicioTecnico.Catalogos.Equipos.AltaEquipo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>Alta de equipo</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtColor" runat="server" CssClass="form-control" placeholder="Color del equipo" MaxLength="50"></asp:TextBox>
                ...
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtDesc" runat="server" CssClass="form-control" placeholder="Laptop, desktop, móvil, etc" MaxLength="50"></asp:TextBox>
                    <div class="col-md-12" style="margin-bottom: 30px;">
                        <div style="position: absolute; top: 0; left: 0;">
                            <asp:RequiredFieldValidator ControlToValidate="txtDesc" ID="RequiredFieldValidator12" runat="server" CssClass="text-danger" ErrorMessage="Descripción es obligatorio">
                            </asp:RequiredFieldValidator>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <asp:TextBox ID="txtEspec" runat="server" CssClass="form-control" placeholder="Especificaciones del equipo" MaxLength="200"></asp:TextBox>
                    <div class="col-md-12" style="margin-bottom: 30px;">
                        <div style="position: absolute; top: 0; left: 0;">
